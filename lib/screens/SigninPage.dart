...
import 'package:possibuild/services/auth/auth_service.dart';
                        ...
                        _isProcessing?const Center(child: CircularProgressIndicator()):Container(
                          ...
                          child: ElevatedButton(onPressed: () async {
                            ...
                            if(_formKey.currentState!.validate()){
                              ...
                              try{
                                final userCredential = FirebaseAuth.instance.signInWithEmailAndPassword(email: emailController.text.trim(), password: passwordController.text.trim());
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                ...
                                Navigator.of(context).push(MaterialPageRoute(builder: (content)=> const SignUp()));
                                },
